...
me.setCollider("circle",0,0,200);
  ...
  re1 = createSprite(330,200,60,25);
  re1.visible=false;
  re2 = createSprite(235+300,200,60,25);
  re2.visible=false;
  re3 = createSprite(235+510,200,60,25);
  re3.visible=false;
  re4 = createSprite(325,400,60,25);
  re4.visible=false;
  re5 = createSprite(235+300,390,60,25);
  re5.visible=false;
  re6 = createSprite(235+510,390,60,25);
  re6.visible=false;
